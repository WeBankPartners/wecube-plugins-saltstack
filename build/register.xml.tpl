...
<package name="saltstack" version="{{PLUGIN_VERSION}}">
    ...
    <systemParameters>
        ...
        <systemParameter name="SALTSTACK_S3_TMP" scopeType="global" defaultValue=""/>
    </systemParameters>
