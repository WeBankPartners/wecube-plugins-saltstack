...
<package name="saltstack" version="{{PLUGIN_VERSION}}">
    ...
    <systemParameters>
                ...
                <systemParameter name="SALTSTACK_SERVER_URL" scopeType="global" defaultValue="http://***REMOVED***:20002"/>
                ...
                <systemParameter name="SALTSTACK_HOST_TOMCAT_SRC" scopeType="global" defaultValue="http://***REMOVED***:9001/wecube-agent/apache-tomcat-7.0.103.tar.gz"/>
    ...
    <plugins>
                ...
                <plugin name="host-file" targetPackage="wecmdb" targetEntity="host_resource_instance" registerName="tomcat" targetEntityFilterRule="">
                    <interface action="copy" path="/saltstack/v1/host-file/copy" filterRule="{state_code eq 'created'}{fixed_date is NULL}">
                        <inputParameters>
                            <parameter datatype="string" required="Y" sensitiveData="N" mappingType="entity" mappingEntityExpression="wecmdb:host_resource_instance.guid">guid</parameter>
                            <parameter datatype="string" required="Y" sensitiveData="N" mappingType="system_variable" mappingSystemVariableName="SALTSTACK_HOST_TOMCAT_SRC">endpoint</parameter>
                            <parameter datatype="string" required="Y" sensitiveData="N" mappingType="entity" mappingEntityExpression="wecmdb:host_resource_instance.intranet_ip>wecmdb:ip_address.code">target</parameter>
                            <parameter datatype="string" required="Y" sensitiveData="N" mappingType="system_variable" mappingSystemVariableName="SALTSTACK_HOST_TOMCAT_PATH">destinationPath</parameter>
                            <parameter datatype="string" required="N" sensitiveData="N" mappingType="system_variable" mappingSystemVariableName="SALTSTACK_HOST_TOMCAT_UNPACK">unpack</parameter>
                            <parameter datatype="string" required="N" sensitiveData="N" mappingType="entity" mappingEntityExpression="wecmdb:host_resource_instance.NONE">fileOwner</parameter>
                        </inputParameters>
                        <outputParameters>
                            <parameter datatype="string" sensitiveData="N" mappingType="entity" mappingEntityExpression="wecmdb:host_resource_instance.guid">guid</parameter>
